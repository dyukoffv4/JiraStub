...
public class JiraStubHeaders extends HttpHeaders {
    JiraStubHeaders() {
        ...
        this.add("X-AREQUESTID", "582x2388286x1");                          // May be generated
        ...
        this.add("Set-Cookie", "JSESSIONID=1131A6172ED22EAE5F9DCE3FF3723C7B; Path=/; Secure; HttpOnly");    // May be generated
        this.add("X-Seraph-LoginReason", "OK");
        this.add("Set-Cookie", "atlassian.xsrf.token=B2UA-2NV2-5DBH-LD1W_c2c658854797860b33a043cb90d9876e1b2fa0eb_lin; Path=/; Secure");    // May be generated
        this.add("X-ASESSIONID", "duhm2u");                                 // May be generated
