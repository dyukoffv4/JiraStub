...
public class JiraStubController {
    ...
    @PostMapping
    public ResponseEntity<?> createIssue(@RequestBody @Validated(Create.class) JiraStubIssue request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateIssue(@PathVariable String id, @RequestBody @Validated(Update.class) JiraStubIssue request) {
